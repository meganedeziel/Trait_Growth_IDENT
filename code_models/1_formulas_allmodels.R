...
saveRDS(main.model.loo, file="main.model.loo.RDS")
...
saveRDS(mb1.loo, file="mb1.loo.RDS")
...
saveRDS(mb2.loo, file="mb2.loo.RDS")
...
saveRDS(mb3.loo, file="mb3.loo.RDS")
...
saveRDS(mh2.loo, file="mh2.loo.RDS")
...
saveRDS(mh3.loo, file="mh3.loo.RDS")
...
saveRDS(mh4.loo, file="mh4.loo.RDS")
...
main.model.loo<-add_criterion(main.model, "loo", moment_match=TRUE)
saveRDS(main.model.loo, file="main.model.nobepa.loo.RDS")
